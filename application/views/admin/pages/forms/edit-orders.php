                                    ...
                                    <div class="col-md-12">
                                        <div class="card card-info">
                                            <form class="form-horizontal " id="order_tracking_form" action="<?= base_url('admin/orders/update-order-tracking/'); ?>" method="POST" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" name="order_id" id="edit_id" value="<?= $_GET["edit_id"] ?>">
                    ...
                    <div class="card card-info overflow-auto">
                        <div class="card-body">
                            <table class="table">
                                ...
                                <?php } ?>
                                <?php
                                if (!empty($order_detls[0]['attachments'])) {
                                    $attachments = json_decode($order_detls[0]['attachments'], true);
                                ?>
                                    <tr>
                                        <th class="w-15px">Order attachments</th>
                                        <td>
                                            <?php foreach ($attachments as $order_attachment) { ?>
                                                <a href="<?= get_image_url($order_attachment) ?>" class="" data-toggle="lightbox" data-gallery="attachment-images">
                                                    <img src="<?= get_image_url($order_attachment) ?>" class="attachment_image" alt="Attachment Image">
                                                </a>
                                            <?php } ?>
                                        </td>
                                    </tr>
