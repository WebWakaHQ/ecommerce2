                                            ...
                                            <div class="card card-info mb-3 mt-2 ">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-flex justify-content-end align-items-center">
                                                        <button type="button" class="btn btn-primary update_return_status_delivery_boy" data-id='<?= $order_detls['order_item_id'] ?>' data-otp-system='<?= $otp_system != 0 ? '1' : '0' ?>'>Submit</button>
                                                    </div>
                                                    <?php
